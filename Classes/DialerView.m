...
//        [[LinphoneManager.instance iapManager] isAvailableAccount];
    }
}
...
- (void)callUpdate:(LinphoneCall *)call state:(LinphoneCallState)state {
    ...
    //update placeholder
    if (callInProgress){
        [_addressField setPlaceholder:@"Enter a number"];
        [NSNotificationCenter.defaultCenter postNotificationName:@"LinphoneHidebuttonSetting" object:self userInfo:nil];
    } else {
        [_addressField setPlaceholder:@"Enter an username"];
    }
