...
- (void)update {
    ...
    time_t callTime = linphone_call_log_get_start_date(callLog);
    
    [_timeLabel setText:[NSDate offsetStringBetweenStartDate:[NSDate dateWithTimeIntervalSince1970:callTime] endDate:[NSDate date]]];
