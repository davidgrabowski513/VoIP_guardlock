...
- (void)updateSelectedButton:(UICompositeViewDescription *)view {
    UIColor *selectedColor = [UIColor colorWithRed:240/255.0 green:54/255.0 blue:0 alpha:1];
    UIColor *normalColor = [UIColor colorWithWhite:1 alpha:0.3];
    ...
    _historyLabel.textColor = _historyButton.selected ? selectedColor : normalColor;
    _keypadLabel.textColor = _dialerButton.selected ? selectedColor : normalColor;
    _contactLabel.textColor = _contactsButton.selected ? selectedColor : normalColor;
