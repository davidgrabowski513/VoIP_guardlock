...
- (void)callDurationUpdate {
	...
	int duration =
		call ? linphone_call_get_duration(call) : 0;
...
- (void)onCurrentCallChange {
	...
	if (!_callView.hidden) {
        ...
        [ContactDisplay setAddressLabel:_displaynameLabel forAddress:addr];
