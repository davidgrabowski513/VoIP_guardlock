...
- (void)viewWillAppear:(BOOL)animated {
    ...
    // add new
    [NSNotificationCenter.defaultCenter addObserver:self
                                           selector:@selector(HideBtnSetting:)
                                               name:@"LinphoneHidebuttonSetting"
                                             object:nil];
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    [NSNotificationCenter.defaultCenter removeObserver:self name:@"LinphoneHidebuttonSetting" object:nil];
...
- (void)changeViewEvent:(NSNotification *)notif {
    ...
    if (view != nil) {
        [self updateTopbar:view];
    }
}

//added new
- (void)HideBtnSetting:(NSNotificationCenter *)notif {
    _settingButton.hidden = YES;
}

- (void)updateTopbar:(UICompositeViewDescription *)view {
    BOOL historyView = [view equal:HistoryListView.compositeViewDescription] || [view equal:HistoryDetailsView.compositeViewDescription];
    BOOL contactsView = [view equal:ContactsListView.compositeViewDescription];
    BOOL dialerView = [view equal:DialerView.compositeViewDescription];
    BOOL chatView = [view equal:ChatsListView.compositeViewDescription] || [view equal:ChatConversationCreateView.compositeViewDescription] || [view equal:ChatConversationView.compositeViewDescription];
    BOOL settingView = [view equal:SettingsView.compositeViewDescription];
    BOOL contactDetailView = [view equal:ContactDetailsView.compositeViewDescription];
